...
public class PushListenerService extends FirebaseMessagingService {
    ...
    public void onNewToken(String token) {
        ...
        MyPinpointApp.getPinpointManager(getApplicationContext()).
                getNotificationClient().registerDeviceToken(token);
    }

    @Override
    public void onMessageReceived(RemoteMessage remoteMessage) {
        super.onMessageReceived(remoteMessage);
        Log.d(TAG, "Message Recived: " + remoteMessage.getData());

        final NotificationClient notificationClient = MyPinpointApp.getPinpointManager(getApplicationContext()).getNotificationClient();
